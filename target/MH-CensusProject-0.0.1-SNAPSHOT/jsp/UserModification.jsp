...
<body>
	...
	<td>
		<div style='float: left; text-align: left'>
			<c:if test="${userLogin=='Administrator'}">
				<p1 align="left">
				<form action="/HibernateWebProject/adminPrevious" method="post">
	...
	<div id="change" class="changeField">
		...
		<form:form class="Sign-Form animate" name="clientvalidate"
			action="/HibernateWebProject/modify" modelAttribute="editTO">
			<div class="container">
				...
				<h4>
					...
					<table align="center">
						...
						<form:input path="educated" name="educated"
								placeholder="Numberic-Values"
								onkeypress="return isNumberKey(event)" />
							</td>
							</tr>
						...
						<form:input path="workers" name="workers"
								placeholder="Numberic-Values"
								onkeypress="return isNumberKey(event)" />
							</td>
							</tr>
