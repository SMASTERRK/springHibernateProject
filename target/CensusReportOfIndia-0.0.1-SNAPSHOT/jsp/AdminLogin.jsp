...
<body>
	...
	<form method="post" action="/HibernateWebProject/filepath">
	...
	<div id="approval" class="RegisterApproval">
		<form:form method="POST" action="/HibernateWebProject/approveUsers">
			<span
	...
	<table style="width: 100%">
		<tr>
			<th>
				<form action="/HibernateWebProject/displayPage" method="post">
					<input type="hidden" name="display" value="Directdisplay" /><input type="submit" value="display" />
				</form>
			</th>
			<th>
